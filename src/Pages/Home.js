...
import home from '../image/anim.gif'
const Home = () => {
  return (
    <div
      id="Home"
    ...
    >
      ...
      <div className="relative flex items-center justify-center flex-col">
        ...
        <p className=" text font-mokoto mt-40 max-sm:mt-36 text-[150px] tracking-wide max-sm:text-5xl ">Ersmeronz'24</p>
        ...
        <div className="text-4xl max-sm:mt-10 mt-10 max-sm:text-sm max-sm:px-5 flex items-center justify-center flex-col gap-2">
        ...
        <a
          ...
          className="  max-sm:mt-10 mt-10 w-80 max-sm:w-60 relative z-10 hover:bg-primary hover:bg-none hover:text-black   bg text-primary  shadow-2xl shadow-primary/50   ring-4 ring-offset-2 ring-offset-primary ring-primary/30 p-3 px-5 text-lg font-light rounded-full  "
        >

          Register Now
        </a>
      </div>
      <div className=" w-[100vw]   h-96  flex items-center   justify-between px-40 absolute z-30 -bottom-48 max-sm:-bottom-10  max-sm:px-2">

        <Lottie animationData={robo} className=" max-sm:ml-28 max-sm:h-40 max-sm:mt-72 absolute h-96 ml-96" />
