...
const About = () => {
  return (
    <div
      id="About"
      className=" relative max-w-[100vw] min-h-[100vh] bg-black flex flex-col items-center gap-5 justify-center text-center"
    >
      ...
      <p className=" text-3xl max-sm:text-xl max-sm:w-full max-sm:px-10 w-3/5">
        ...
        minds from across the nation come together to showcase their ingenuity
